...
public class InsertCodeUtils {
	...
	public static byte[] operateClassByteCode(byte[] classByteAry) throws Exception {
...
//		ClassVisitor classAdapter = new IClassAdapter(classWriter, classReader.getClassName());
		ClassVisitor classAdapter = new ASMModifyCode("com/robust/toney/patch",classWriter);
