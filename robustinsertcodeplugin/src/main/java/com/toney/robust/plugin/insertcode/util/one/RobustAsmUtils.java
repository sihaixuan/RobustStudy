...
public final class RobustAsmUtils {
	...
	public final static String REDIRECTCLASSNAME = "Lcom/robust/toney/patch/IChangeQuickRedirect;";
	public final static String PROXYCLASSNAME = "com/robust/toney/patch/utils/PatchProxy";
...
//				"([Ljava/lang/Object;Ljava/lang/Object;"+REDIRECTCLASSNAME+"Z)Z");
		mv.visitMethodInsn(Opcodes.INVOKESTATIC,
				PROXYCLASSNAME,
				"isSupport",
				"([Ljava/lang/Object;Ljava/lang/Object;"+REDIRECTCLASSNAME+"Z)Z",false);
		...
		mv.visitMethodInsn(Opcodes.INVOKESTATIC,
				PROXYCLASSNAME, 
				"accessDispatch", 
				"([Ljava/lang/Object;Ljava/lang/Object;"+REDIRECTCLASSNAME+"Z)Ljava/lang/Object;",true);
